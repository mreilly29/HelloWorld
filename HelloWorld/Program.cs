...
namespace HelloWorld
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //This is shortcut (--> visual studio standard toolbar)
            ...
            ////Part nine string equality example
            ...
            ////do while loop.. use this if the program has to run AT LEAST once (so he'll ask at least one soldier)
            //string action = " ";
            //do
            //{
            //    Console.WriteLine("What is your rank soldier?");
